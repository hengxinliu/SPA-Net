...
def main():
    ...
    #torch.save(model.state_dict(), os.path.join(ckpts, "NEW_CPU_496.pth"), _use_new_zipfile_serialization=False)
...
# python test.py --mode=1 --is_out=True --verbose=True --use_TTA=True --postprocess=True --snapshot=True --restore=model_epoch_.pth --cfg=DMFNet_GDL_all --gpu=0
