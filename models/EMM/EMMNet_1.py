...
if __name__ == '__main__':
    ...
    print("ptflops_FLOPS: " + flops)
    print("ptflops_Params: " + params)
    # # (2)
    # ##thop only cals official model and third calculation mothod
    # flops,params = profile(model,inputs=(x,),verbose=False)
    # flops, params = clever_format([flops, params], "%.3f")
    # print("thopflops_FLOPS: {}".format(flops))
    # print("thopflops_params: {}".format(params))

    # (3)
    # stat(model,(4,128,128,128))
    y = model(x)
    print(y.shape)
