...
def main():
    ...
    if args.is_out:
        out_dir = './output/{}/{}'.format(args.cfg,args.restore)
...
# python test.py --mode=1 --is_out=True --verbose=True --use_TTA=True --postprocess=True --snapshot=True --restore=model_last.pth --cfg=DMFNet_GDL_all --gpu=3
